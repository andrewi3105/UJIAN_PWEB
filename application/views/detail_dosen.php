<style>
    ...
    .content {
        padding: 30px;
        background-color: #e1bee7; /* Soft pastel blue */
        border-radius: 12px;
    ...
    .back-button {
        ...
        left: 20px;
        padding: 10px 20px;
        background-color: #ab47bc; /* Baby blue */
        color: #fff;
        border: none;
        border-radius: 5px;
    ...
    .profile-photo {
        ...
        object-fit: cover;
        cursor: pointer;
        border: 3px solid #81D4FA; /* Blue border around the photo */
    ...
    .table th {
        background-color: #ab47bc; /* Light blue */
        color: white;
        font-weight: bold;
        text-align: left;
    ...
    .table tr:hover {
        background-color: #e1bee7; /* Slightly darker blue for hover effect */
    }
...
<div class="content">
    ...
    <a href="<?= base_url('index.php/dosen'); ?>" class="back-button">
    ...
    <!-- Display the dosen's photo centered below the title -->
    <img src="<?php echo base_url('uploads/' . $detail->foto_dosen); ?>" alt="Foto Dosen" class="profile-photo" onclick="openModal('<?php echo base_url('uploads/' . $detail->foto_dosen); ?>')">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><?php echo $detail->nomer_induk_dosen ?></td>
        </tr>
        <tr>
            <th>Mata Kuliah</th>
            <td><?php echo $detail->mata_kuliah_dosen ?></td>
        </tr>
        <tr>
            <th>Program Studi</th>
            <td><?php echo $detail->program_studi_dosen ?></td>
        </tr>
        <tr>
            <th>No. Telepon</th>
            <td><?php echo $detail->no_telp_dosen; ?></td>
        </tr>
        <tr>
            <th>Email</th>
            <td><?php echo $detail->email_dosen; ?></td>
        </tr>
    </table>
</div>
